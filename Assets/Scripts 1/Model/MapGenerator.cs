    ...
    public class MapGenerator : MonoBehaviour
    {
        ...
        {          
            ...
            for (int r = 0; r < maxRooms; r++)                                              // Try to place as many rooms as the specified maxRooms
            {
                ...
                int roomXPosition = UnityEngine.Random.Range(0, width - roomWidth - 1);
            ...
            {                                                                               // Don't do anything with the first room, so start at r = 1 instead of r = 0               
                ...
                if (UnityEngine.Random.Range(1, 2) == 1)                                            // Give a 50/50 chance of which 'L' shaped connecting hallway to tunnel out
                {
